...
public class Exoniumplantstage4Block extends ModexoniaModElements.ModElement {

	@ObjectHolder("modexonia:exoniumplantstage_4")
	public static final Block block = null;

	public Exoniumplantstage4Block(ModexoniaModElements instance) {
		super(instance, 101);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("exoniumplantstage_4");
		}
