...
public class Exoniumplantstage7Block extends ModexoniaModElements.ModElement {
	@ObjectHolder("modexonia:exoniumplantstage_7")
	public static final Block block = null;

	public Exoniumplantstage7Block(ModexoniaModElements instance) {
		super(instance, 104);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("exoniumplantstage_7");
		}
