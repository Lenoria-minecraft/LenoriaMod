...
public class Exoniumplantstage0Block extends ModexoniaModElements.ModElement {
	@ObjectHolder("modexonia:exoniumplantstage_0")
	public static final Block block = null;

	public Exoniumplantstage0Block(ModexoniaModElements instance) {
		super(instance, 97);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("exoniumplantstage_0");
		}
