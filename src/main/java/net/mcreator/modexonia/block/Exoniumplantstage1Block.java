...
public class Exoniumplantstage1Block extends ModexoniaModElements.ModElement {
	@ObjectHolder("modexonia:exoniumplantstage_1")
	public static final Block block = null;

	public Exoniumplantstage1Block(ModexoniaModElements instance) {
		super(instance, 98);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("exoniumplantstage_1");
		}
