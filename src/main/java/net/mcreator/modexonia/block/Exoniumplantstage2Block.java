...
public class Exoniumplantstage2Block extends ModexoniaModElements.ModElement {

	@ObjectHolder("modexonia:exoniumplantstage_2")
	public static final Block block = null;

	public Exoniumplantstage2Block(ModexoniaModElements instance) {
		super(instance, 99);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("exoniumplantstage_2");
		}
